...
async def auto_rename_files(client, message):
    ...
    if not format_template:
        return await message.reply_text(
            "<b>⚠️ Didn't find any Rename Format ⁉️</b>\n"
            "<blockquote>➪ Plᴇᴀsᴇ, Sᴇᴛ An Auᴛᴏ Rᴇnᴀʍᴀᴇ Fᴏʀʍᴀᴛ Firsᴛ. Usᴇ **/autorename**</blockquote>"
        )
    ...
    if episode_number:
        ...
        try:
            path = await client.download_media(
                ...
                progress_args=("🌀 Dᴏᴡɴʟᴏᴀᴅ ᴛᴏ Dᴀᴛᴀʙᴀsᴇ ➪ ⌸", download_msg, time.time())
            )
