...
class Database:
    ...
    #async def set_start_msg(self, msgs):
        #await self.start_msg.update_one({},{'$set': {'text_msg': msgs})

    #async def get_text_msg(self):
        #document = await self.start_msg.find_one({}, {'text_msg': 1})
        #return document.get('text_msg') if document else None
    ...
    # Methods for AUTHO_USER set using the separate collection
